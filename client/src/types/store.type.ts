...
export interface ChatState {
  ...
  ) => Promise<Message>; // Function to send a direct message
  sendGroupMessage: (
    ...
    clientSequence: number | undefined,
    clientGroupId: string | undefined,
  ) => Promise<Message>; // Function to send a group message
  ...
  setMessageUploading: (conversationId: string, clientMessageId: string, isUploading: boolean) => void;
}
